  ...
  try {
    ...
    await client.insert({
      ...
      values: events.map((event) => ({
        ...
        source: event.source,
        h3_res0: event.h3_res0,
        h3_res1: event.h3_res1,
        h3_res2: event.h3_res2,
        h3_res3: event.h3_res3,
        h3_res4: event.h3_res4,
        h3_res5: event.h3_res5,
        h3_res6: event.h3_res6,
        h3_res7: event.h3_res7,
        h3_res8: event.h3_res8,
        h3_res9: event.h3_res9,
        h3_res10: event.h3_res10,
      })),
      format: 'JSONEachRow',
    });
  } catch (error) {
